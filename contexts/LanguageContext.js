...
export const translations = {
	es: {
		...
		about: {
			...
			description:
				"Soy un desarrollador frontend apasionado por el diseño y la tecnología. Me especializo en crear interfaces que no solo se ven bien, sino que funcionan de manera excepcional.",
		...
		contact: {
			...
			description:
				"Siempre estoy abierto a nuevos proyectos y colaboraciones interesantes. Si tienes una idea, hablemos.",
			form: {
				name: "Nombre",
	...
	en: {
		...
		about: {
			...
			description:
				"I am a frontend developer passionate about design and technology. I specialize in creating interfaces that not only look good, but work exceptionally.",
			skillsTitle: "Skills",
			skills: [
		...
		contact: {
			...
			description:
				"I'm always open to new projects and interesting collaborations. If you have an idea, let's talk.",
			form: {
				name: "Name",
